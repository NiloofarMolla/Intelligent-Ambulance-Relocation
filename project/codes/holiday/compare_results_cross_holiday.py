...
FILE_BASELINE = SCRIPT_DIR / "response_summary_2_holiday.csv"
FILE_RL = SCRIPT_DIR / "response_summary_cross_holiday.csv"
...
def main():
    ...
    ax.set_title('Impact of RL in HOLIDAY SCENARIO (30-Run Statistical Avg)', fontsize=14, fontweight='bold')
    ax.set_xticks(x);
    ...
    save_path = SCRIPT_DIR / "chart_comparison_baseline_vs_rl_cross_holiday_STATISTICAL.png"
    ...
    df_table.to_csv(SCRIPT_DIR / "statistical_comparison_table_cross_holiday.csv", index=False)
    print("\n--- Formal Academic Table (Holiday) ---")
